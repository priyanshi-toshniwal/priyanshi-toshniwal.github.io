export default class Gallery3 {
    ...
    injectStyles() {
      ...
      :host {
        --g3-color-bg-primary: #faf5f0;
        --g3-color-bg-secondary: #ffffff;
        --g3-color-font-primary: #3d2817;
        --g3-color-accent-primary: #b8451b;
        --g3-color-button-bg: #3d2817;
        --g3-color-button-border: #8b5a3c;
        --g3-color-navbar-primary: #3d2817;
      }
